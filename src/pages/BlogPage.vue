...
<template>
  <section class="page-header reveal">
    ...
    <h1 class="page-title">Пишу про backend, архитектуру, автоматизацию и процесс разработки.</h1>
    <p class="page-lead">
      Здесь собираю разборы, заметки и практические наблюдения из разработки.
    </p>
    <p class="page-lorem">
      Материалы сгруппированы по году публикации и открываются на отдельных страницах.
    </p>
  </section>
